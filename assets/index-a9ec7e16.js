 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t($,R){var M=$.length;$.push(R);e:for(;0<M;){var q=M-1>>>1,P=$[q];if(0<i(P,R))$[q]=R,$[M]=P,M=q;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var R=$[0],M=$.pop();if(M!==R){$[0]=M;e:for(var q=0,P=$.length,z=P>>>1;q<z;){var T=2*(q+1)-1,D=$[T],g=T+1,V=$[g];if(0>i(D,M))g<P&&0>i(V,D)?($[q]=V,$[g]=M,q=g):($[q]=D,$[T]=M,q=T);else if(g<P&&0>i(V,M))$[q]=V,$[g]=M,q=g;else break e}}return R}function i($,R){var M=$.sortIndex-R.sortIndex;return M!==0?M:$.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var u=[],c=[],v=1,m=null,h=3,S=!1,x=!1,w=!1,O=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p($){for(var R=n(c);R!==null;){if(R.callback===null)r(c);else if(R.startTime<=$)r(c),R.sortIndex=R.expirationTime,t(u,R);else break;R=n(c)}}function y($){if(w=!1,p($),!x)if(n(u)!==null)x=!0,yt(C);else{var R=n(c);R!==null&&Ie(y,R.startTime-$)}}function C($,R){x=!1,w&&(w=!1,d(I),I=-1),S=!0;var M=h;try{for(p(R),m=n(u);m!==null&&(!(m.expirationTime>R)||$&&!he());){var q=m.callback;if(typeof q=="function"){m.callback=null,h=m.priorityLevel;var P=q(m.expirationTime<=R);R=e.unstable_now(),typeof P=="function"?m.callback=P:m===n(u)&&r(u),p(R)}else r(u);m=n(u)}if(m!==null)var z=!0;else{var T=n(c);T!==null&&Ie(y,T.startTime-R),z=!1}return z}finally{m=null,h=M,S=!1}}var N=!1,A=null,I=-1,Q=5,F=-1;function he(){return!(e.unstable_now()-F<Q)}function fe(){if(A!==null){var $=e.unstable_now();F=$;var R=!0;try{R=A(!0,$)}finally{R?ye():(N=!1,A=null)}}else N=!1}var ye;if(typeof a=="function")ye=function(){a(fe)};else if(typeof MessageChannel<"u"){var Ve=new MessageChannel,je=Ve.port2;Ve.port1.onmessage=fe,ye=function(){je.postMessage(null)}}else ye=function(){O(fe,0)};function yt($){A=$,N||(N=!0,ye())}function Ie($,R){I=O(function(){$(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){x||S||(x=!0,yt(C))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function($){switch(h){case 1:case 2:case 3:var R=3;break;default:R=h}var M=h;h=R;try{return $()}finally{h=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,R){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var M=h;h=$;try{return R()}finally{h=M}},e.unstable_scheduleCallback=function($,R,M){var q=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?q+M:q):M=q,$){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=M+P,$={id:v++,callback:R,priorityLevel:$,startTime:M,expirationTime:P,sortIndex:-1},M>q?($.sortIndex=M,t(c,$),n(u)===null&&$===n(c)&&(w?(d(I),I=-1):w=!0,Ie(y,M-q))):($.sortIndex=P,t(u,$),x||S||(x=!0,yt(C))),$},e.unstable_shouldYield=he,e.unstable_wrapCallback=function($){var R=h;return function(){var M=h;h=R;try{return $.apply(this,arguments)}finally{h=M}}}})(uc);sc.exports=uc;var Gd=sc.exports;/**
 * @license React
...
`,ir="/test-Smart/assets/BigHouse-c214781e.png",yi="/test-Smart/assets/BigHouse@2x-9ad69bcd.png",or="/test-Smart/assets/HouseImage-e8bc0a3f.png",xi="/test-Smart/assets/HouseImage@2x-bc11d9e6.png",lr="/test-Smart/assets/InHouse-73f9f3ef.png",wi="/test-Smart/assets/InHouse@2x-02588930.png",T0=()=>f.jsx(j0,{children:f.jsxs(_0,{children:[f.jsxs(Ga,{children:[f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${or} 1x, ${xi} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${or} 1x, ${xi} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${or} 1x, ${xi} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${or} 1x, ${xi} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:or,alt:"house"})]}),f.jsx(Ga,{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${lr} 1x, ${wi} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${lr} 1x, ${wi} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${lr} 1x, ${wi} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${lr} 1x, ${wi} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:lr,alt:"InHouse"})]})})]}),f.jsx($0,{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${ir} 1x, ${yi} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${ir} 1x, ${yi} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${ir} 1x, ${yi} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${ir} 1x, ${yi} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:ir,alt:"Bighouse"})]})}),f.jsxs(P0,{children:[f.jsx("h2",{children:"О компании"}),f.jsx("p",{children:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry`s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged."}),f.jsx(I0,{children:f.jsxs(z0,{children:["Читать",f.jsx(N0,{src:ys,alt:"ArrowRight"})]})})]})]})}),L0=E.section`
  padding: 30px;
...
`,B0="/test-Smart/assets/NumberOne-17607b9f.svg",U0="/test-Smart/assets/NumberTwo-c8f36833.svg",H0=()=>f.jsx(f.Fragment,{children:f.jsxs(L0,{children:[f.jsx(O0,{children:"Основные задачи"}),f.jsxs(A0,{children:[f.jsxs(Ya,{children:[f.jsx(R0,{src:B0}),f.jsx(D0,{children:"Создание комфортных условий и повышение качества обслуживания клиентов"})]}),f.jsxs(Ya,{children:[f.jsx(M0,{src:U0}),f.jsx(F0,{children:"Постоянно совершенствовать качество предоставляемых услуг путем обучения персонала, закупки нового оборудования и усиленной рекламы на рынке"})]})]})]})}),V0=E.section`
  padding: 30px;
  ${j.tablet} {
    padding: 60px;
  }
...
`,xs="/test-Smart/assets/arrowLight-0c8efdb5.svg",Si="/test-Smart/assets/Bar-667101af.png",ki="/test-Smart/assets/Bar@2x-a71b92c5.png",mn="/test-Smart/assets/SunHouse-d3a1001d.png",Ci="/test-Smart/assets/SunHouse@2x-846c9eae.png",sr="/test-Smart/assets/Stadium-5a5b434f.png",Ei="/test-Smart/assets/Stadium@2x-ae2c3bd2.png",ur="/test-Smart/assets/Appartment-5a2e7102.png",ji="/test-Smart/assets/Appartment@2x-163f2c7a.png",ar="/test-Smart/assets/StadiumGreate-15286127.png",$i="/test-Smart/assets/StadiumGreate@2x-4401cf06.png",eg=()=>f.jsxs(V0,{children:[f.jsx(W0,{children:"Наши проекты"}),f.jsxs(Q0,{children:[f.jsxs(G0,{children:[f.jsxs(Y0,{children:[f.jsx("source",{srcSet:`${Si} 1x, ${ki} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${Si} 1x, ${ki} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${Si} 1x, ${ki} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${Si} 1x, ${ki} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:mn,alt:"HouseSun"})]}),f.jsx(K0,{children:"ДОСУГОВЫЙ ЦЕНТР"}),f.jsxs(X0,{children:["ПОДРОБНЕЕ",f.jsx(Ka,{src:xs,alt:"ArrowLight"})]})]}),f.jsx(Z0,{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${mn} 1x, ${Ci} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${mn} 1x, ${Ci} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${mn} 1x, ${Ci} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${mn} 1x, ${Ci} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:mn,alt:"HouseSun"})]})})]}),f.jsxs(J0,{children:[f.jsx("div",{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${sr} 1x, ${Ei} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${sr} 1x, ${Ei} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${sr} 1x, ${Ei} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${sr} 1x, ${Ei} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:sr,alt:"HouseSun"})]})}),f.jsx("div",{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${ur} 1x, ${ji} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${ur} 1x, ${ji} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${ur} 1x, ${ji} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${ur} 1x, ${ji} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:ur,alt:"HouseSun"})]})}),f.jsx("div",{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${ar} 1x, ${$i} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${ar} 1x, ${$i} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${ar} 1x, ${$i} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${ar} 1x, ${$i} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:ar,alt:"HouseSun"})]})})]}),f.jsx(b0,{children:f.jsxs(q0,{children:["ВСЕ ПРОЕКТЫ ",f.jsx(Ka,{src:xs,alt:"ArrowLight"})]})})]}),tg=E.section`
  padding: 30px;
  ${j.tablet} {
    padding: 60px;
  }
...
`,fr="/test-Smart/assets/CallImage-84ef3975.png",Pi="/test-Smart/assets/CallImage@2x-a46c4955.png",fg=()=>{const[e,t]=Me.useState("*"),[n,r]=Me.useState(""),[i,o]=Me.useState(""),[l,s]=Me.useState(""),[u,c]=Me.useState(""),[v,m]=Me.useState(""),h=p=>{p.preventDefault(),t("*")},S=p=>{r(p.target.value)},x=p=>{o(p.target.value)},w=p=>{s(p.target.value),t("*")},O=p=>{c(p.target.value),t("*")},d=p=>{m(p.target.value),t("*")},a=()=>{r(""),s(""),c(""),m(""),t(""),o("")};return f.jsxs(tg,{children:[f.jsx(ng,{children:"Связаться с нами"}),f.jsxs(rg,{children:[f.jsx(lg,{children:f.jsxs("form",{style:{display:"flex",flexDirection:"column"},onClick:h,children:[f.jsx(cr,{children:f.jsx(_i,{type:"text",placeholder:"Имя",value:n,onChange:S})}),f.jsxs(cr,{children:[f.jsx(_i,{type:"number",placeholder:"Номер телефона",value:l,onChange:w}),l.length===0&&f.jsx("span",{style:{color:"#C30000",fontSize:"14px",position:"absolute",left:"140px",top:"14px"},children:e})]}),f.jsxs(cr,{children:[f.jsx(_i,{type:"text",placeholder:"E-mail",value:u,onChange:O}),u.length===0&&f.jsx("span",{style:{color:"#C30000",fontSize:"14px",position:"absolute",left:"65px",top:"14px"},children:e})]}),f.jsx(cr,{children:f.jsx(_i,{type:"text",placeholder:"Интересующий товар/услуга",value:i,onChange:x})}),f.jsxs(cr,{children:[f.jsx(og,{name:"",id:"",cols:"30",rows:"10",placeholder:"Сообщение",value:v,onChange:d}),v.length===0&&f.jsx("span",{style:{color:"#C30000",fontSize:"14px",position:"absolute",left:"94px",top:"14px"},children:e})]}),f.jsx(sg,{children:"Отправляя заявку Вы соглашаетесь с политикой конфиденциальности"}),f.jsx(cg,{children:f.jsxs(ag,{onClick:a,children:["ОТПРАВИТЬ ",f.jsx(ug,{src:xs,alt:"ArrowLight"})]})})]})}),f.jsx(ig,{children:f.jsxs("picture",{children:[f.jsx("source",{srcSet:`${fr} 1x, ${Pi} 2x`,media:"(max-width: 767px)"}),f.jsx("source",{srcSet:`${fr} 1x, ${Pi} 2x`,media:"(max-width: 1279px)"}),f.jsx("source",{srcSet:`${fr} 1x, ${Pi} 2x`,media:"(min-width: 1280px)"}),f.jsx("source",{srcSet:`${fr} 1x, ${Pi} 2x`,media:"(min-width: 1440px)"}),f.jsx("img",{src:fr,alt:"CallImagen"})]})})]})]})},dg=E.footer`
...
`,_g=E.p`
  ...
  text-align: center;
  margin-top: 24px;
`,Pg="/test-Smart/assets/LogoFooter-8afcb13f.svg",zg="/test-Smart/assets/GeoLocation-f2b1b0d7.svg",Ng="/test-Smart/assets/Phone-b3c19150.svg",Ig="/test-Smart/assets/Email-30e5c790.svg",Tg="/test-Smart/assets/Facebook-d8718d87.svg",Lg="/test-Smart/assets/LinkedIn-2cb1e857.svg",Og="/test-Smart/assets/twiter-14a9cfc9.svg",Ag="/test-Smart/assets/pininterest-8eba4f8b.svg",Rg=()=>f.jsxs(dg,{children:[f.jsxs(pg,{children:[f.jsxs(gg,{children:[f.jsx(vg,{src:Pg,alt:"logo"}),f.jsxs(yg,{children:[f.jsx(yl,{children:"Информация"}),f.jsxs("ul",{children:[f.jsx(dr,{children:f.jsx("a",{children:"Главная"})}),f.jsx(dr,{children:f.jsx("a",{children:"Галерея"})}),f.jsx(dr,{children:f.jsx("a",{children:"Проекты"})}),f.jsx(dr,{children:f.jsx("a",{children:"Сертифиаты "})}),f.jsx(dr,{children:f.jsx("a",{children:"Контакт"})})]})]}),f.jsxs(hg,{children:[f.jsx(yl,{children:"Контакты"}),f.jsxs("ul",{children:[f.jsxs(xl,{children:[f.jsx(xg,{src:zg,alt:"GeoLocation"}),f.jsxs("a",{href:"https://goo.gl/maps/DaUrFrGB6oiANadv9",children:["100000, Республика Казахстан, ",f.jsx("br",{}),"г. Караганда, ул. Телевизионная 10"]})]}),f.jsxs(xl,{children:[f.jsx(wg,{src:Ng,alt:"PhoneIcon"}),f.jsx("a",{href:"tel:+38 (000) 000 00 00",children:"+38 (000) 000 00 00"})]}),f.jsxs(xl,{children:[f.jsx(Sg,{src:Ig,alt:"EmailIcon"}),f.jsx("a",{href:"mailto:mail@gmail.com",children:"mail@gmail.com"})]})]})]})]}),f.jsxs(mg,{children:[f.jsx(yl,{children:"Социальные сети"}),f.jsxs("ul",{style:{display:"flex"},children:[f.jsx(zi,{children:f.jsx("a",{children:f.jsx(kg,{src:Tg,alt:"Icon"})})}),f.jsx(zi,{children:f.jsx("a",{children:f.jsx(Eg,{src:Og,alt:"Icon"})})}),f.jsx(zi,{children:f.jsx("a",{children:f.jsx(Cg,{src:Lg,alt:"Icon"})})}),f.jsx(zi,{children:f.jsxs("a",{children:[f.jsx(jg,{src:Ag,alt:"Icon"})," "]})})]})]})]}),f.jsx($g,{}),f.jsx(_g,{children:"© 2019 Digital Project. Все права защищены."})]});function Mg(){return f.jsxs(f.Fragment,{children:[f.jsx(c0,{}),f.jsx(E0,{}),f.jsx(T0,{}),f.jsx(H0,{}),f.jsx(eg,{}),f.jsx(fg,{}),f.jsx(Rg,{})]})}wl.createRoot(document.getElementById("root")).render(f.jsx(et.StrictMode,{children:f.jsx(Mg,{})}));
